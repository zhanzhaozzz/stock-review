      ...
      <div className="bg-card rounded-xl p-4 border border-edge">
        <div className="flex gap-3">
          ...
          <button
            onClick={runRating}
            disabled={running}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:bg-input text-sm font-medium rounded-lg transition"
          >
            {running ? "评级中..." : "执行评级"}
          </button>
        </div>
                ...
                {ratings.map((r, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        <div className="text-xs text-dim">{r.code}</div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <span
                          className={`px-2 py-0.5 rounded text-xs font-medium ${
                            RATING_COLORS[r.rating] || "bg-input"
                          }`}
                        >
                          {r.rating}
                        </span>
